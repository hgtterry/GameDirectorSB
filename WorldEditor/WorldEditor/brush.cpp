...
typedef void (*BrushList_Uint32CB)(Brush *pBrush, const Guint32 uVal);
...
static void	BrushList_SetUint32(BrushList *bl, const Guint32 uVal, BrushList_Uint32CB cbSetUint)
{
	Brush	*b;
...
Guint32	Brush_GetColor(const Brush *b)
{
	assert(b != NULL);
...
void	Brush_SetColor(Brush *b, const Guint32 newcolor)
{
	assert(b != NULL);
...
static	Guint8		sides[256];
static	Guint8		fsides[256];
