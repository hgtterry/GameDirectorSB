...
void		Render_UpdateTexInfoId(GPlane *p, Guint16 TId);
...
void		Render_RenderTreeHollowOrtho(ViewVars *Cam, GNode *n, HDC ViewDC);
void		Render_RenderOrthoGridFromSize(ViewVars *v, geFloat Interval, HDC ViewDC);
void		Render_RenderTree(ViewVars *, GNode *n, HDC, int RFlags);
void		Render_RenderTreeOrtho(ViewVars *, GNode *n, HDC);
...
BOOL		Render_CastRay(GNode *n, geVec3d *p1, geVec3d *p2);
