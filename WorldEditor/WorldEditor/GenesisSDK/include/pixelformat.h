...
typedef Guint32	(*gePixelFormat_Composer   )(int R,int G,int B,int A);
typedef void	(*gePixelFormat_Decomposer )(Guint32 Pixel,int *R,int *G,int *B,int *A);

typedef void	(*gePixelFormat_ColorGetter)(Guint8 **ppData,int *R,int *G,int *B,int *A);
typedef void	(*gePixelFormat_ColorPutter)(Guint8 **ppData,int  R,int  G,int  B,int  A);

typedef Guint32	(*gePixelFormat_PixelGetter)(Guint8 **ppData);
typedef void	(*gePixelFormat_PixelPutter)(Guint8 **ppData,Guint32 Pixel);
...
GENESISAPI Guint32		GENESISCC gePixelFormat_ComposePixel(	gePixelFormat Format,int R,int G,int B,int A);
GENESISAPI void			GENESISCC gePixelFormat_DecomposePixel(	gePixelFormat Format,Guint32 Pixel,int *R,int *G,int *B,int *A);
			
															// these four functions move ppData to the next pixel

GENESISAPI void			GENESISCC gePixelFormat_GetColor(gePixelFormat Format,Guint8 **ppData,int *R,int *G,int *B,int *A);
GENESISAPI void			GENESISCC gePixelFormat_PutColor(gePixelFormat Format,Guint8 **ppData,int R,int G,int B,int A);

GENESISAPI Guint32		GENESISCC gePixelFormat_GetPixel(gePixelFormat Format,Guint8 **ppData);
GENESISAPI void			GENESISCC gePixelFormat_PutPixel(gePixelFormat Format,Guint8 **ppData,Guint32 Pixel);
	
GENESISAPI Guint32		GENESISCC gePixelFormat_ConvertPixel(gePixelFormat Format,Guint32 Pixel,gePixelFormat ToFormat);
