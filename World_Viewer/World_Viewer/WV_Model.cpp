...
// *************************************************************************
void WV_Model::Reset_Class(void)
{
	Model_Loaded = 0;
	Model_Type = 0;// Enums::LoadedFile_None;
...
// *************************************************************************
void WV_Model::Convert_To_GlobalMesh(void)
{
	int Count = 0;
...
// *************************************************************************
void WV_Model::Set_Groupt_Count(int Count)
{
	GroupCount = Count;
}
...
// *		Set_Groupt_Count:- Terry and Hazel Flanigan 2023	  		   *
// *************************************************************************
void WV_Model::Set_Texture_Count(int Count)
{
	TextureCount = Count;
}
...
// *			Set_Groupt_Count:- Terry and Hazel Flanigan 2023	   	   *
// *************************************************************************
void WV_Model::Set_Motion_Count(int Count)
{
	MotionCount = Count;
}
...
// *************************************************************************
void WV_Model::Create_Mesh_Group(int Index)
{
...
// *************************************************************************
void WV_Model::Set_BondingBox_Model(bool Create)
{
	if (Create == 1)
	{
...
// *************************************************************************
void WV_Model::Clear_Model_And_Reset(void)
{
