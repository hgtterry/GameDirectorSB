...
// *									Load 							   *
// *************************************************************************
bool WV_Import_3DT::Load(const char* FileName)
{
...
// *************************************************************************
Level* WV_Import_3DT::Level_CreateFromFile(const char* FileName)// , const char** ErrMsg, const char* DefaultHeadersDir, const char* DefaultActorsDir, const char* DefaultPawnIni)
{
	int NumModels = 0;
	int VersionMajor = 0;
	int VersionMinor = 0;
...
Level* WV_Import_3DT::Level_Create(const char* pWadName, const char* HeadersDir, const char* ActorsDir, const char* PawnIni)
{
	Level* pLevel = NULL;
...
char* WV_Import_3DT::Util_Strdup(const char* s)
{
	char* rslt;
