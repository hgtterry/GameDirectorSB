...
WV_Debug_Render::WV_Debug_Render(void)
{
...
void WV_Debug_Render::drawSphere(const btVector3& p, btScalar radius, const btVector3& color)
{
	//FlashWindow(App->MainHwnd,true);
}

void WV_Debug_Render::drawLine(const btVector3& from, const btVector3& to, const btVector3& fromColor, const btVector3& toColor)
{
	
}

void WV_Debug_Render::drawLine (const btVector3 &from, const btVector3 &to, const btVector3 &color)
{
...
void WV_Debug_Render::drawTriangle (const btVector3 &v0, const btVector3 &v1, const btVector3 &v2, const btVector3 &color, btScalar)
{
	//FlashWindow(App->MainHwnd,true);
}

void WV_Debug_Render::drawContactPoint (const btVector3 &PointOnB, const btVector3 &normalOnB, btScalar distance, int lifeTime, const btVector3 &color)
{
	//FlashWindow(App->MainHwnd,true);
}

void WV_Debug_Render::reportErrorWarning (const char *warningString)
{
	//FlashWindow(App->MainHwnd,true);
}

void WV_Debug_Render::draw3dText (const btVector3 &location, const char *textString)
{
	//FlashWindow(App->MainHwnd,true);
}

void WV_Debug_Render::setDebugMode (int debugMode)
{
	m_debugMode = (DebugDrawModes) DBG_DrawWireframe;
}

int WV_Debug_Render::getDebugMode() const{
...
// *************************************************************************
void WV_Debug_Render::renderQueueStarted(Ogre::uint8 queueGroupId, const String& invocation,bool& skipThisInvocation)
{ 
	Render_Debug();
}
// *************************************************************************
...
// *************************************************************************
void WV_Debug_Render::renderQueueEnded(Ogre::uint8 queueGroupId, const String& invocation, bool& repeatThisInvocation)
{
...
// *************************************************************************
void WV_Debug_Render::PreRender()
{
...
// *************************************************************************
void WV_Debug_Render::PostRender()
{
...
// *************************************************************************
void WV_Debug_Render::Render_Debug_Bullet()
{
...
// *************************************************************************
bool WV_Debug_Render::Render_Debug(void)
{
...
// *************************************************************************
void WV_Debug_Render::Clear_Debug_Render()
{
	btDebug_Manual->beginUpdate(0);
	btDebug_Manual->position(0, 0, 0);
	btDebug_Manual->colour(ColourMain);
