...
{
	App->CL_SplitterViews->Draw_Screen(App->CL_SplitterViews->Left_Window_Hwnd);
	App->CL_SplitterViews->Draw_Screen(App->CL_SplitterViews->Right_Window_Hwnd);
	App->CL_SplitterViews->Draw_Screen(App->CL_SplitterViews->Bottom_Left_Hwnd);
}

// *************************************************************************
// *						Draw_Screen Terry Flanigan		  			   *
// *************************************************************************
void WE_SpliterViews::Draw_Screen(HWND hwnd)
{
...
LRESULT CALLBACK WE_SpliterViews::Left_Window_Proc(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_PAINT:
	{
		App->CL_SplitterViews->Draw_Screen(hDlg);
		return 0;
	}
