...
bool WV_App::InitApp(void)
{
	...
	CL_Scene =			new WV_World();
	CL_Export_Ogre =	new WV_Export_Ogre();
	CL_PB =				new WV_PB();
	CL_Load_Ogre =		new WV_Load_Ogre();
	CL_Keyboard =		new WV_Keyboard();
	CL_Dialogs =		new WV_Dialogs();
	CL_Bullet =			new	WV_Bullet();
	CL_TopTabs =		new WV_TopTabs();
	CL_Player =			new WV_Player();
	CL_Properties =		new WV_Properties();
	CL_Physics =		new WV_Physics();
	...
	CL_CUtil =			new CUtil();
	CL_CList =			new CList();
	CL_CGroup =			new CGroup();
	CL_CModel =			 new CModel();

	CL_CFusionDoc =		new CFusionDoc();
