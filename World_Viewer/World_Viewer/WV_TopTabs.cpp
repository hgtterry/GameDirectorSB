...
// *************************************************************************
void WV_TopTabs::Project_Loaded_Reset()
{
...
// *************************************************************************
bool WV_TopTabs::Start_TopBar_Globals()
{
	Top_Bar = CreateDialog(App->hInst, (LPCTSTR)IDD_TOPBAR, App->MainHwnd, (DLGPROC)TopBar_Globals_Proc);
	//Init_Bmps_Globals();
	return 1;
}
...
// *************************************************************************
LRESULT CALLBACK WV_TopTabs::TopBar_Globals_Proc(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam)
{
	switch (message)
	{
	case WM_INITDIALOG:
	{
		...
		App->CL_TopTabs->TabsHwnd = hDlg;
		App->CL_TopTabs->Start_Tabs_Headers();
		App->CL_TopTabs->Start_Camera_TB();
...
// *************************************************************************
void WV_TopTabs::Start_Tabs_Headers(void)
{
	Tabs_TB_hWnd = CreateDialog(App->hInst, (LPCTSTR)IDD_TB_TAB, App->CL_TopTabs->TabsHwnd, (DLGPROC)Tabs_Headers_Proc);
}

// *************************************************************************
// *							Tabs_Headers_Proc_Proc					   *
// *************************************************************************
LRESULT CALLBACK WV_TopTabs::Tabs_Headers_Proc(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam)
{
	switch (message)
	{
	case WM_INITDIALOG:
	...
	case WM_NOTIFY:
	{
		...
		{
			LPNMCUSTOMDRAW item = (LPNMCUSTOMDRAW)some_item;
			App->Custom_Button_Toggle_Tabs(item, App->CL_TopTabs->Toggle_Tabs_Camera_Flag);
			return CDRF_DODEFAULT;
		}
...
// *************************************************************************
void WV_TopTabs::Hide_Tabs(void)
{
...
// *************************************************************************
void WV_TopTabs::Reset_Main_Controls(void)
{
...
// *************************************************************************
void WV_TopTabs::Start_Camera_TB(void)
{
...
// *************************************************************************
LRESULT CALLBACK WV_TopTabs::Camera_TB_Proc(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_NOTIFY:
	{
		...
		{
			LPNMCUSTOMDRAW item = (LPNMCUSTOMDRAW)some_item;
			App->Custom_Button_Toggle(item, App->CL_TopTabs->Toggle_FreeCam_Flag);
			return CDRF_DODEFAULT;
		}
		...
		{
			LPNMCUSTOMDRAW item = (LPNMCUSTOMDRAW)some_item;
			App->Custom_Button_Toggle(item, App->CL_TopTabs->Toggle_FirstCam_Flag);
			return CDRF_DODEFAULT;
		}
		...
		{
			LPNMCUSTOMDRAW item = (LPNMCUSTOMDRAW)some_item;
			App->Custom_Button_Toggle(item, App->CL_TopTabs->Toggle_3rdCam_Flag);
			return CDRF_DODEFAULT;
		}
	...
	case WM_COMMAND:
	{
		...
		if (LOWORD(wParam) == IDC_FIRST_MODE)
		{
			if (App->CL_Scene->Player_Added == 1)
			{
				...
				App->CL_TopTabs->Toggle_FirstCam_Flag = 1;
				App->CL_TopTabs->Toggle_FreeCam_Flag = 0;

				App->CL_Scene->B_Player[0]->Player_Node->setVisible(false);

				App->CL_Ogre->OgreListener->GD_Run_Physics = 1;

				RedrawWindow(App->CL_TopTabs->Camera_TB_hWnd, NULL, NULL, RDW_INVALIDATE | RDW_UPDATENOW);
			}
			return TRUE;
		}
		...
		if (LOWORD(wParam) == IDC_FREECAM)
		{
			if (App->CL_Scene->World_Loaded == 1)
			{
				...
				App->CL_TopTabs->Toggle_FirstCam_Flag = 0;
				App->CL_TopTabs->Toggle_FreeCam_Flag = 1;
...
// *************************************************************************
void WV_TopTabs::Init_Bmps_Camera(void)
{
...
// *************************************************************************
void WV_TopTabs::Init_Bmps_Globals(void)
{
...
// *************************************************************************
void WV_TopTabs::Start_Game_TB(void)
{
...
// *************************************************************************
LRESULT CALLBACK WV_TopTabs::Game_TB_Proc(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam)
{
...
// *************************************************************************
void WV_TopTabs::Init_Bmps_Game()
{
...
// *************************************************************************
void WV_TopTabs::Start_Locations_TB(void)
{
...
// *************************************************************************
LRESULT CALLBACK WV_TopTabs::Locations_TB_Proc(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam)
{
...
// *************************************************************************
void WV_TopTabs::Init_Bmps_Locations()
{
...
// *************************************************************************
void WV_TopTabs::Start_Editors_TB(void)
{
...
// *			Editors_TB_Proc:- Terry and Hazel Flanigan 2022			   *
// *************************************************************************
LRESULT CALLBACK WV_TopTabs::Editors_TB_Proc(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam)
{
...
// *************************************************************************
void WV_TopTabs::Start_Files_TB(void)
{
...
// *************************************************************************
LRESULT CALLBACK WV_TopTabs::Files_TB_Proc(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam)
{
...
// *************************************************************************
void WV_TopTabs::Init_Bmps_Files()
{
...
// *************************************************************************
void WV_TopTabs::UnCheck_All_MouseOption(HWND hDlg)
{
