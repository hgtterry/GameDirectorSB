...
// *************************************************************************
void ME_Logger::Log_Message_To_File(char* Message)
{
	if (App->Debug_App == 1)
	{
...
// *************************************************************************
// *				Show:- Terry and Hazel Flanigan 2023				   *
// *************************************************************************
void ME_Logger::Show(int int_Number, float float_Number, char* Message, Ogre::Vector3 Vector3)
{
	char Temp[MAX_PATH];
...
// *************************************************************************
void ME_Logger::Log_Data_GUI(void)
{
