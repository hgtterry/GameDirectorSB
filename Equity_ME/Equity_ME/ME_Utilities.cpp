...
// *************************************************************************
bool ME_Utilities::TestForBadCharactors(char* buf)
{
	strcpy(Return_Chr, "");
	char bufnew[256];
	strcpy(bufnew, "");
...
// *************************************************************************
bool ME_Utilities::ReverseBackSlash(char* buf)
{
	strcpy(Return_Chr, "");
	char bufnew[256];
	strcpy(bufnew, "");
...
// *************************************************************************
bool ME_Utilities::OpenHTML(char* HelpTitle)
{
	char Path[1024];
...
// *************************************************************************
float ME_Utilities::floatPercent(int Val)
{
...
// *************************************************************************
float ME_Utilities::DegreesToRadians(float Degrees)
{
	float Radians = (Degrees * ((float)3.14159265358979323846f)) / 180;
	return Radians;
}
...
// *************************************************************************
float ME_Utilities::RadiansToDegrees(float Radians)
{
