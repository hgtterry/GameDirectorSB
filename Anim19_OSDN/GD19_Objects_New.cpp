...
bool GD19_Objects_New::Add_New_MessageEntity()
{
	...
	Object->OgreEntity = App->Cl19_Ogre->mSceneMgr->createEntity(ATest, "Test_cube.mesh", App->Cl19_Ogre->PermResourceGroup);
	Object->OgreNode = App->Cl19_Ogre->mSceneMgr->getRootSceneNode()->createChildSceneNode();
	Object->OgreNode->attachObject(Object->OgreEntity);
...
bool GD19_Objects_New::Add_New_MoveEntity()
{
	...
	Object->OgreEntity = App->Cl19_Ogre->mSceneMgr->createEntity(ATest, "DoorEntity_GD.mesh", App->Cl19_Ogre->PermResourceGroup);
	Object->OgreNode = App->Cl19_Ogre->mSceneMgr->getRootSceneNode()->createChildSceneNode();
	Object->OgreNode->attachObject(Object->OgreEntity);
	Object->OgreNode->scale(1, 1, 1);
...
bool GD19_Objects_New::Add_New_TeleportEntity()
{
	...
	Object->OgreEntity = App->Cl19_Ogre->mSceneMgr->createEntity(ATest, "TeleportSend.mesh", App->Cl19_Ogre->PermResourceGroup);
	Object->OgreNode = App->Cl19_Ogre->mSceneMgr->getRootSceneNode()->createChildSceneNode();
	Object->OgreNode->attachObject(Object->OgreEntity);
	Object->OgreNode->scale(1, 1, 1);
...
bool GD19_Objects_New::Add_New_EnvironmentEntity()
{
	...
	Object->OgreEntity = App->Cl19_Ogre->mSceneMgr->createEntity(ATest, "GD10Env.mesh", App->Cl19_Ogre->PermResourceGroup);
	Object->OgreNode = App->Cl19_Ogre->mSceneMgr->getRootSceneNode()->createChildSceneNode();
	Object->OgreNode->attachObject(Object->OgreEntity);
	Object->OgreNode->scale(1, 1, 1);
...
bool GD19_Objects_New::Add_New_Area_Change()
{
	...
	Object->OgreEntity = App->Cl19_Ogre->mSceneMgr->createEntity(ATest, "GD10RoomChange.mesh", App->Cl19_Ogre->PermResourceGroup);
	Object->OgreNode = App->Cl19_Ogre->mSceneMgr->getRootSceneNode()->createChildSceneNode();
	Object->OgreNode->attachObject(Object->OgreEntity);
	Object->OgreNode->scale(1, 1, 1);
...
bool GD19_Objects_New::Add_New_Change_Level()
{
	...
	Object->OgreEntity = App->Cl19_Ogre->mSceneMgr->createEntity(ATest, "TeleportRecieve.mesh", App->Cl19_Ogre->PermResourceGroup);
	Object->OgreNode = App->Cl19_Ogre->mSceneMgr->getRootSceneNode()->createChildSceneNode();
	Object->OgreNode->attachObject(Object->OgreEntity);
	Object->OgreNode->scale(1, 1, 1);
