...
void SB_Gui_Environment::Start_Environment_Editor(int Index,bool IsTeleport)
{
	...
	Ambient_Colour_Copy.x = App->SBC_Scene->V_Object[Eviron_Index]->S_Environ[0]->AmbientColour.x;
	Ambient_Colour_Copy.y = App->SBC_Scene->V_Object[Eviron_Index]->S_Environ[0]->AmbientColour.y;
	Ambient_Colour_Copy.z = App->SBC_Scene->V_Object[Eviron_Index]->S_Environ[0]->AmbientColour.z;

	Ambient_Colour.x = App->SBC_Scene->V_Object[Eviron_Index]->S_Environ[0]->AmbientColour.x;
	Ambient_Colour.y = App->SBC_Scene->V_Object[Eviron_Index]->S_Environ[0]->AmbientColour.y;
	Ambient_Colour.z = App->SBC_Scene->V_Object[Eviron_Index]->S_Environ[0]->AmbientColour.z;

	Ambient_Int_Red = Ambient_Colour.x * 255;
	Ambient_Int_Green = Ambient_Colour.y * 255;
	Ambient_Int_Blue = Ambient_Colour.z * 255;

	Fog_Colour_Copy.x = App->SBC_Scene->V_Object[Eviron_Index]->S_Environ[0]->Fog_Colour.x;
	Fog_Colour_Copy.y = App->SBC_Scene->V_Object[Eviron_Index]->S_Environ[0]->Fog_Colour.y;
	Fog_Colour_Copy.z = App->SBC_Scene->V_Object[Eviron_Index]->S_Environ[0]->Fog_Colour.z;

	Fog_Colour.x = App->SBC_Scene->V_Object[Eviron_Index]->S_Environ[0]->Fog_Colour.x;
	Fog_Colour.y = App->SBC_Scene->V_Object[Eviron_Index]->S_Environ[0]->Fog_Colour.y;
	Fog_Colour.z = App->SBC_Scene->V_Object[Eviron_Index]->S_Environ[0]->Fog_Colour.z;
...
void SB_Gui_Environment::Environ_PropertyEditor()
{
	...
	if (PropertyEditor_Page == 0)
	{
		...
		if (ImGui::ColorEdit3("", (float*)&Ambient_Colour, ImGuiColorEditFlags_NoInputs | misc_flags2))
		{
			...
			App->SBC_Scene->V_Object[Eviron_Index]->S_Environ[0]->AmbientColour = Ogre::Vector3(Ambient_Colour.x, Ambient_Colour.y, Ambient_Colour.z);
	...
	if (PropertyEditor_Page == 1)
	{
		...
		ImGui::SameLine();
		ImGui::Text("%s", App->SBC_Scene->V_Object[Eviron_Index]->S_Environ[0]->Sound_File);
		...
		if (ClickOnTrack)
		{
			...
			strcpy(App->SBC_SoundMgr->Access_File, App->SBC_Scene->V_Object[Eviron_Index]->S_Environ[0]->Sound_File);
			...
			if (App->SBC_SoundMgr->IsCancelled == 0)
			{
				...
				strcpy(App->SBC_Scene->V_Object[Eviron_Index]->S_Environ[0]->Sound_File, App->SBC_SoundMgr->Access_File);
				App->SBC_Scene->V_Object[Eviron_Index]->S_Environ[0]->SndVolume = App->SBC_SoundMgr->SndVolume;
		...
		ImGui::SameLine();
		ImGui::Text("%f", App->SBC_Scene->V_Object[Eviron_Index]->S_Environ[0]->SndVolume);
		if (ClickOnVolume)
		{
			App->SBC_Com_Environments->Mark_As_Altered_Environ(Eviron_Index);
			ClickOnVolume = 0;
		...
		ImGui::SameLine();
		ImGui::Text("%i", App->SBC_Scene->V_Object[Eviron_Index]->S_Environ[0]->Play);
		if (ClickOnPlay)
		{
			strcpy(App->Cl_Dialogs->btext, "Set Play Sound Track");

			App->Cl_Dialogs->TrueFlase = App->SBC_Scene->V_Object[Eviron_Index]->S_Environ[0]->Play;
			...
			if (App->Cl_Dialogs->Canceled == 0)
			{
				...
				{
					App->SBC_Scene->V_Object[Eviron_Index]->S_Environ[0]->Play = 1;
					App->SBC_Com_Environments->Set_Environment_By_Index(1, Eviron_Index);
				}
				else
				{
					App->SBC_Scene->V_Object[Eviron_Index]->S_Environ[0]->Play = 0;
					App->SBC_Com_Environments->Set_Environment_By_Index(0, Eviron_Index);
				}
		...
		ImGui::SameLine();
		ImGui::Text("%i", App->SBC_Scene->V_Object[Eviron_Index]->S_Environ[0]->Loop);
		if (ClickOnLoop)
		{
			strcpy(App->Cl_Dialogs->btext, "Set Play Sound Loop");

			App->Cl_Dialogs->TrueFlase = App->SBC_Scene->V_Object[Eviron_Index]->S_Environ[0]->Loop;
			...
			if (App->Cl_Dialogs->Canceled == 0)
			{
				if (App->Cl_Dialogs->TrueFlase == 1)
				{
					App->SBC_Scene->V_Object[Eviron_Index]->S_Environ[0]->Loop = 1;
					App->SBC_Com_Environments->Set_Environment_By_Index(0, Eviron_Index);
					App->SBC_Com_Environments->Set_Environment_By_Index(1, Eviron_Index);
				}
				else
				{
					App->SBC_Scene->V_Object[Eviron_Index]->S_Environ[0]->Loop = 0;
					App->SBC_Com_Environments->Set_Environment_By_Index(0, Eviron_Index);
					App->SBC_Com_Environments->Set_Environment_By_Index(1, Eviron_Index);
				}
	...
	if (PropertyEditor_Page == 2)
	{
		...
		ImGui::SameLine();
		ImGui::Text("%i", App->SBC_Scene->V_Object[Eviron_Index]->S_Environ[0]->Fog_On);
		if (ClickOnFogVisible)
		{
			strcpy(App->Cl_Dialogs->btext, "Set Fog Visiblity");

			App->Cl_Dialogs->TrueFlase = App->SBC_Scene->V_Object[Eviron_Index]->S_Environ[0]->Fog_On;
			...
			if (App->Cl_Dialogs->Canceled == 0)
			{
				if (App->Cl_Dialogs->TrueFlase == 1)
				{
					App->SBC_Scene->V_Object[Eviron_Index]->S_Environ[0]->Fog_On = 1;
					EnableFog(true);
				}
				else
				{
					App->SBC_Scene->V_Object[Eviron_Index]->S_Environ[0]->Fog_On = 0;
					EnableFog(false);
				}
		...
		ImGui::SameLine();
		ImGui::Text("%i", App->SBC_Scene->V_Object[Eviron_Index]->S_Environ[0]->Fog_Mode);
		if (ClickOnFogMode)
		{
			ClickOnFogMode = 0;
		}
		...
		if (ImGui::ColorEdit3("", (float*)&Fog_Colour, ImGuiColorEditFlags_NoInputs | misc_flags2))
		{
			...
			App->SBC_Scene->V_Object[Eviron_Index]->S_Environ[0]->Fog_Colour = Ogre::Vector3(Fog_Colour.x, Fog_Colour.y, Fog_Colour.z);

			if (App->SBC_Scene->V_Object[Eviron_Index]->S_Environ[0]->Fog_On == 1)
			{
				EnableFog(true);
			}
		...
		// ----------------- Start
		ImGui::Text("Start:- ", App->SBC_Scene->V_Object[Eviron_Index]->S_Environ[0]->Fog_Start);
		ImGui::SameLine();
		
		if (ImGui::InputFloat("##1", &App->SBC_Scene->V_Object[Eviron_Index]->S_Environ[0]->Fog_Start, 1, 0, "%.3f"))
		{
			if (App->SBC_Scene->V_Object[Eviron_Index]->S_Environ[0]->Fog_On == 1)
			{
				EnableFog(true);
		...
		// ----------------- End
		ImGui::Text("End:-   ", App->SBC_Scene->V_Object[Eviron_Index]->S_Environ[0]->Fog_End);
		ImGui::SameLine();

		if (ImGui::InputFloat("##2", &App->SBC_Scene->V_Object[Eviron_Index]->S_Environ[0]->Fog_End, 1, 0, "%.3f"))
		{
			if (App->SBC_Scene->V_Object[Eviron_Index]->S_Environ[0]->Fog_On == 1)
			{
				EnableFog(true);
	...
	if (PropertyEditor_Page == 3)
	{
		...
		ImGui::SameLine();
		ImGui::Text("%i", App->SBC_Scene->V_Object[Eviron_Index]->S_Environ[0]->Enabled);
		if (ClickOnSkyEnabled)
		{
			strcpy(App->Cl_Dialogs->btext, "Set Sky Visiblity");

			App->Cl_Dialogs->TrueFlase = App->SBC_Scene->V_Object[Eviron_Index]->S_Environ[0]->Enabled;
			...
			if (App->Cl_Dialogs->Canceled == 0)
			{
				if (App->Cl_Dialogs->TrueFlase == 1)
				{
					App->SBC_Scene->V_Object[Eviron_Index]->S_Environ[0]->Enabled = 1;
					SetSky(1);
				}
				else
				{
					App->SBC_Scene->V_Object[Eviron_Index]->S_Environ[0]->Enabled = 0;
					SetSky(0);
				}
		...
		// ----------------- Tiling
		ImGui::Text("Tiling:- ", App->SBC_Scene->V_Object[Eviron_Index]->S_Environ[0]->Tiling);
		ImGui::SameLine();

		if (ImGui::InputFloat("##5", &App->SBC_Scene->V_Object[Eviron_Index]->S_Environ[0]->Tiling, 0.5, 0, "%.3f"))
		{
			if (App->SBC_Scene->V_Object[Eviron_Index]->S_Environ[0]->Enabled == 1)
			{
				SetSky(true);
			}
		...
		// ----------------- Curvature
		ImGui::Text("Curve:- ", App->SBC_Scene->V_Object[Eviron_Index]->S_Environ[0]->Curvature);
		ImGui::SameLine();

		if (ImGui::InputFloat("##6", &App->SBC_Scene->V_Object[Eviron_Index]->S_Environ[0]->Curvature, 0.5, 0, "%.3f"))
		{
			if (App->SBC_Scene->V_Object[Eviron_Index]->S_Environ[0]->Enabled == 1)
			{
				SetSky(true);
	...
	if (Is_Teleport == 1)
	{
		...
		{
			App->SBC_Scene->B_Player[0]->Phys_Body->getWorldTransform().setOrigin(App->SBC_Scene->V_Object[Eviron_Index]->S_Teleport[0]->Physics_Position);
			App->SBC_Scene->B_Player[0]->Phys_Body->getWorldTransform().setRotation(App->SBC_Scene->V_Object[Eviron_Index]->S_Teleport[0]->Physics_Rotation);
			Set_To_PlayerView();
		}

		ImGui::SameLine();
		if (ImGui::Checkbox("Enabled", &App->SBC_Scene->V_Object[Eviron_Index]->S_Environ[0]->Environ_Enabled))
		{
