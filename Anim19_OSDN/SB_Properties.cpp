...
// *************************************************************************
// *	Update_ListView_UserObjects:- Terry and Hazel Flanigan 2023	 	   *
// *************************************************************************
bool SB_Properties::Update_ListView_UserObjects()
{
...
// *************************************************************************
// *		Edit_UserObjects_Onclick:- Terry and Hazel Flanigan 2023	   *
// *************************************************************************
void SB_Properties::Edit_UserObjects_Onclick(LPARAM lParam)
{
	int Index = App->SBC_Properties->Current_Selected_Object;
	int result = 1;
	int test;
...
bool SB_Properties::Update_ListView_Area()
{
	...
	grid[0][2] = "Materials",	grid[1][2] = App->SBC_Scene->B_Area[Index]->Material_File;
