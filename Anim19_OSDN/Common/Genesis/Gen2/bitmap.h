...
typedef struct geBitmap_Info
{
	...
	Guint32					ColorKey;	// meaningless unless HasColorKey ; the ColorKey is a Pixel in Format
...
GENESISAPI geBoolean 	GENESISCC	geBitmap_SetFormat(geBitmap *Bmp, 
							...
							geBoolean RespectColorKey, Guint32 ColorKey,
...
GENESISAPI geBoolean	GENESISCC	geBitmap_SetColorKey(geBitmap *Bmp, geBoolean HasColorKey, Guint32 ColorKey, geBoolean Smart);
...
GENESISAPI Guint32		GENESISCC	geBitmap_MipBytes(const geBitmap * Bitmap,int mip);
...
GENESISAPI geBoolean		GENESISCC	geBitmap_Palette_SetEntry(      geBitmap_Palette *P,int Color,Guint32 Pixel);
GENESISAPI geBoolean		GENESISCC	geBitmap_Palette_GetEntry(const geBitmap_Palette *P,int Color,Guint32 *Pixel);
