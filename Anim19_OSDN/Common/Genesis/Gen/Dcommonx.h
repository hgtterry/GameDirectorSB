...
typedef geRDriver_THandle *DRIVERCC CREATE_TEXTURE(Gint32 Width, Gint32 Height, Gint32 NumMipLevels, const geRDriver_PixelFormat *PixelFormat);
typedef geBoolean DRIVERCC DESTROY_TEXTURE(geRDriver_THandle *THandle);

typedef geBoolean DRIVERCC LOCK_THANDLE(geRDriver_THandle *THandle, Gint32 MipLevel, void **Data);
typedef geBoolean DRIVERCC UNLOCK_THANDLE(geRDriver_THandle *THandle, Gint32 MipLevel);
...
typedef geBoolean DRIVERCC THANDLE_GET_INFO(geRDriver_THandle *THandle, Gint32 MipLevel, geRDriver_THandleInfo *Info);
...
typedef geBoolean DRIVERCC DRAW_DECAL(geRDriver_THandle *THandle, RECT *SRect, Gint32 x, Gint32 y);
