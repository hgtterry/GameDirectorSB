...
GENESISAPI	geEngine	*geEngine_CreateWithVersion(HWND hWnd, const char *AppName, const char *DriverDirectory, Guint32 Version);
...
GENESISAPI geBoolean	geEngine_Printf(geEngine *Engine, Gint32 x, Gint32 y, const char *String, ...);

GENESISAPI void			GENESISCC geEngine_RenderPoly(const geEngine *Engine, const GE_TLVertex *Points, int NumPoints, const geBitmap *Texture, Guint32 Flags);
...
GENESISAPI geBoolean	geDriver_ModeGetWidthHeight(geDriver_Mode *Mode, Gint32 *Width, Gint32 *Height);
...
GENESISAPI geBoolean    geWorld_AddActor       (geWorld *World, geActor *Actor, Guint32 Flags, Guint32 UserFlags);
GENESISAPI geBoolean	geWorld_SetActorFlags  (geWorld *World, geActor *Actor, Guint32 Flags);
...
GENESISAPI void			geWorld_ModelSetFlags(geWorld_Model *Model, Guint32 ModelFlags);
GENESISAPI Guint32		geWorld_ModelGetFlags(geWorld_Model *Model);
...
GENESISAPI geBoolean	geWorld_SetLTypeTable(geWorld *World, Gint32 LType, const char *Table);
...
GENESISAPI geBoolean geWorld_Collision(	geWorld *World,				// World to collide with
										...
										Guint32 Contents,			// Contents to collide with (use GE_CONTENTS_SOLID_CLIP for default)
										Guint32 CollideFlags,		// To mask out certain object types (GE_COLLIDE_ALL, etc...)
										Guint32 UserFlags,			// To mask out actors (refer to geActor_SetUserFlags)
...
GENESISAPI geBoolean geWorld_GetContents(geWorld *World, const geVec3d *Pos, const geVec3d *Mins, const geVec3d *Maxs, Guint32 Flags, Guint32 UserFlags, GE_CollisionCB *CollisionCB, void *Context, GE_Contents *Contents);
...
GENESISAPI	geBoolean gePoly_GetLVertex(gePoly *Poly, Gint32 Index, GE_LVertex *LVert);
GENESISAPI	geBoolean gePoly_SetLVertex(gePoly *Poly, Gint32 Index, const GE_LVertex *LVert);

// World visibility
GENESISAPI geBoolean	geWorld_GetLeaf(const geWorld *World, const geVec3d *Pos, Gint32 *Leaf);
GENESISAPI geBoolean	geWorld_MightSeeLeaf(const geWorld *World, Gint32 Leaf);

GENESISAPI geBoolean	geWorld_LeafMightSeeLeaf(const geWorld *World, Gint32 Leaf1, Gint32 Leaf2, Guint32 VisFlags);
...
typedef Guint32				geCSNetMgr_NetID;
...
GENESISAPI 	geBoolean		GENESISCC geCSNetMgr_FindSession(geCSNetMgr *M, const char *IPAdress, geCSNetMgr_NetSession **SessionList, Gint32 *SessionNum );
...
GENESISAPI geBoolean		GENESISCC geCSNetMgr_ReceiveFromServer(geCSNetMgr *M, geCSNetMgr_NetMsgType *Type, Gint32 *Size, Guint8 **Data);
GENESISAPI geBoolean		GENESISCC geCSNetMgr_ReceiveFromClient(geCSNetMgr *M, geCSNetMgr_NetMsgType *Type, geCSNetMgr_NetID *IdClient, Gint32 *Size, Guint8 **Data);
...
GENESISAPI geBoolean		GENESISCC geCSNetMgr_ReceiveAllMessages(geCSNetMgr *M, geCSNetMgr_NetID *IdFrom, geCSNetMgr_NetID *IdTo, geCSNetMgr_NetMsgType *Type, Gint32 *Size, Guint8 **Data);
...
GENESISAPI geBoolean		GENESISCC geCSNetMgr_SendToServer(geCSNetMgr *M, geBoolean Guaranteed, Guint8 *Data, Gint32 DataSize);
GENESISAPI geBoolean		GENESISCC geCSNetMgr_SendToClient(geCSNetMgr *M, geCSNetMgr_NetID To, geBoolean Guaranteed, Guint8 *Data, Gint32 DataSize);
