...
GD19_Resources::GD19_Resources(void)
{
	FX_General_hLV = NULL;
...
// *************************************************************************
void GD19_Resources::Start_Resources(void)
{
...
// *							Materials_Proc	  						   *
// *************************************************************************
LRESULT CALLBACK GD19_Resources::Resources_Proc(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam)
{		
	switch (message)
	{
	case WM_INITDIALOG:
...
// *************************************************************************
bool GD19_Resources::CreateListGeneral_FX(HWND hDlg)
{
	int NUM_COLS = 4;
...
// *************************************************************************
bool GD19_Resources::ShowAllMaterials()
{
	LV_ITEM pitem;
...
// *************************************************************************
bool GD19_Resources::ShowUsedMaterials()
{
	LV_ITEM pitem;
	memset(&pitem, 0, sizeof(LV_ITEM));
	pitem.mask = LVIF_TEXT;
...
// *************************************************************************
bool GD19_Resources::ShowAllTextures()
{
	LV_ITEM pitem;
	memset(&pitem, 0, sizeof(LV_ITEM));
	pitem.mask = LVIF_TEXT;
...
// *************************************************************************
bool GD19_Resources::ShowAllMeshes()
{
	Ogre::String st;
	int NUM_COLS = 4;
...
// *************************************************************************
bool GD19_Resources::SearchFolders(char* File,char* StartFolder)
{
...
// *************************************************************************
bool GD19_Resources::FindPath(char* SubFolder,char* File,char* StartFolder)
{
	char pSearchPath[1024];
	char pReturnPath[1024];
	char *pPartPath;
...
// *************************************************************************
void GD19_Resources::Start_List_Folders(HWND List,char *FileName,bool ListDlg)
{
...
// *************************************************************************
void GD19_Resources::List_Folders(HWND List,char *StartFolder,char *FileName,bool ListDlg)
{
...
// *************************************************************************
bool GD19_Resources::FindPath_New(char* File,char* Folder)
{
	char pSearchPath[1024];
	char pReturnPath[1024];
	char *pPartPath;
...
// *************************************************************************
void GD19_Resources::List_MeshMaterials(HWND List)
{
	SendMessage(List,LB_RESETCONTENT, 0,0);
...
// *************************************************************************
void GD19_Resources::Unload_Materials(void)
{
	int Count = 0;
...
// *************************************************************************
void GD19_Resources::Remove_OblectMesh(void)
{
	int Count = 0;
	while (Count < App->Cl_Scene_Data->ObjectCount) // Remove Ogre Objects
	{
