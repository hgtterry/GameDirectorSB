...
// *************************************************************************
void GD19_Dialogs::Start_Mouse_Sensitivity()
{
	DialogBox(App->hInst, (LPCTSTR)IDD_MOUSESENSITIVITY, App->Fdlg, (DLGPROC)Mouse_Sensitivity_Proc);
}
// *************************************************************************
// *				Dialog_OgreReloadMesh_Proc Terry Bernie	  			   *
// *************************************************************************
LRESULT CALLBACK GD19_Dialogs::Mouse_Sensitivity_Proc(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam)
{
