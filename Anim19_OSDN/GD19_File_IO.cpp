...
// *************************************************************************
bool GD19_File_IO::OpenFile(char* Extension, char* Title, char* StartDirectory)
{
...
// *************************************************************************
bool GD19_File_IO::SaveFileCom(char* Extension, char* Title, char* StartDirectory)
{
	ZeroMemory(&ofn, sizeof(ofn));
	ofn.lStructSize = sizeof(ofn);
	ofn.hwndOwner = App->MainHwnd;
...
// *							SaveFile		  			  		 	   *
// *************************************************************************
bool GD19_File_IO::SaveFile(char* Extension, char* Title, char* FileName)
{
...
// *************************************************************************
bool GD19_File_IO::Update_File_Info(char* Full_Path, char* File_Name)
{
...
// *************************************************************************
bool GD19_File_IO::SearchFolders(char* Path, char* File)
{
...
// *							StartBrowser   							   *
// *************************************************************************
bool GD19_File_IO::StartBrowser(char* szInitDir)
{
...
// *						BrowseCallbackProc   						   *
// *************************************************************************
int __stdcall GD19_File_IO::BrowseCallbackProc(HWND  hwnd, UINT  uMsg, LPARAM  lParam, LPARAM  lpData)
{
